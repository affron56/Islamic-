...
"    ""Jama Masjid Of Agra"", ""Mehmed Paå¡A Sokoloviä‡ Bridge"", ""Rumi'S Mausoleum"", ""Alaeddin Mosque"", ""Ulu Camii"", ""Sultan Qaboos Grand Mosque"", "
...
"    ""Ebrahim Kalin"", ""Amr Khaled"", ""Tariq Anwar"", ""Mahmoud Abbas"", ""Rashid Al-Ghannushi"", ""Mustafa Akyol"", ""M. Fethullah Gã¼Len"", ""Sã¼Leyman Ateåÿ"", "
...
"    ""Al-Raziâ€™S Medical Texts"", ""Ibn Sinaâ€™S Canon Of Medicine"", ""Geographical Mapping Techniques"", ""Cartographic Projections"", ""Ibn Battutaâ€™S Travel Records"","
...
"    ""Geometric Theorems"", ""Trigonometric Identities"", ""Astronomical Instruments"", ""Al-Kindiâ€™S Cryptanalysis"", ""Early Cryptography Techniques"","
...
"    ""Samanid Empire"", ""Nasrid Kingdom Of Granada"", ""Emirate Of Cã³Rdoba"", ""Caliphate Of Cã³Rdoba"", ""Ghuri Dynasty"","
...
"    ""Barid Shahi Dynasty"", ""Bahmani Sultanate"", ""Rashidun Caliphate"", ""Umayyad Emirate Of Cã³Rdoba"", ""Hafsid Dynasty"","
...
"    ""Herbal-Catalog"", ""Al-Raziâ€™S-Distillation"", ""Ibn-Sinaâ€™S-Pharmacopoeia"", ""Astronomical-Tables"", ""Observatory-Instruments"","
...
"    ""Duha"", ""Mawlid-Observance"", ""Zamzam-Drinking"", ""Saâ€™I"", ""Raml"", ""Ritual-Cleansing"", ""Prayer-Beads"","
